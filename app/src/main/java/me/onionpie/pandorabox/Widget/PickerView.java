...
public class PickerView extends View {
     ...
     */
    public static final float MARGIN_ALPHA = 6.5f;
    /**
     * 自动回滚到中间的速度
     */
...
//		mCurrentSelected = 0;
    ...
    private void drawOtherText(Canvas canvas, int position, int type) {
        float d = (float) (MARGIN_ALPHA * mMinTextSize * position + type
                * mMoveLen);
        float scaleAlpha = parabola(mViewHeight / 4.0f, d);
        float size = (mMaxTextSize - mMinTextSize) * scaleAlpha + mMinTextSize;
//        mPaint.setTextSize(size);
...
//        mPaint.setTextSize(size);
        ...
        mPaint.setAlpha((int) ((mMaxTextAlpha - mMinTextAlpha) * scaleAlpha + mMinTextAlpha));
