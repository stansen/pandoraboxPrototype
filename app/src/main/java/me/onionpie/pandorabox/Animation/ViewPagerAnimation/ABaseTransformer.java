...
public abstract class ABaseTransformer implements PageTransformer {
	 ...
	 * @param position
	 *            Position of page relative to the current front-and-center iPosition of the pager. 0 is front and
	 *            center. 1 is one full page iPosition to the right, and -1 is one page iPosition to the left.
	 */
	...
	/**
	 * If the iPosition offset of a fragment is less than negative one or greater than one, returning true will set the
